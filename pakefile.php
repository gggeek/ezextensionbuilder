...
*/
function run_dist( $task=null, $args=array(), $cliospts=array() )
{
    $opts = eZExtBuilder::getOpts( @$args[0] );
...
pake_longdesc( 'generate-documentation' );
...
pake_longdesc( 'convert-configuration' );
